...
extension Xoshiro256StarStar: Equatable {
	/// Compares two `Xoshiro256StarStar` objects for equality
	///
	/// Two `Xoshiro256StarStar` objects are equal if their 256-bit state is the same.
	///
	/// - parameter lhs: lhs
	/// - parameter rhs: rhs
	///
