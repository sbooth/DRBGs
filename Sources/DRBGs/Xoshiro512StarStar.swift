...
//		precondition(seed != (0, 0, 0, 0, 0, 0, 0, 0), "Seed may not be zero")
		state = seed
	}
...
extension Xoshiro512StarStar: Equatable {
	/// Compares two ``Xoshiro512StarStar`` objects for equality
	///
	/// Two ``Xoshiro512StarStar`` objects are equal if their 512-bit state is the same.
	///
	/// - parameter lhs: lhs
	/// - parameter rhs: rhs
	///
	/// - returns: `true` if the two objects have the same state, `false` otherwise
	public static func ==(lhs: Xoshiro512StarStar, rhs: Xoshiro512StarStar) -> Bool {
